...
.border-uae-green {
  --tw-border-opacity: 1;
  border-color: rgb(0 150 57 / var(--tw-border-opacity, 1));
}
.bg-background {
  background-color: hsl(var(--background));
}
...
.bg-uae-green {
  --tw-bg-opacity: 1;
  background-color: rgb(0 150 57 / var(--tw-bg-opacity, 1));
}
.bg-uae-green\/10 {
  background-color: rgb(0 150 57 / 0.1);
}
.bg-uae-red\/10 {
  background-color: rgb(206 17 38 / 0.1);
}
.bg-white {
  --tw-bg-opacity: 1;
...
.via-uae-green {
  --tw-gradient-to: rgb(0 150 57 / 0)  var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), #009639 var(--tw-gradient-via-position), var(--tw-gradient-to);
}
.to-uae-gold {
  --tw-gradient-to: #FFD700 var(--tw-gradient-to-position);
}
.to-uae-green {
  --tw-gradient-to: #009639 var(--tw-gradient-to-position);
}
.bg-clip-text {
...
.text-uae-green {
  --tw-text-opacity: 1;
  color: rgb(0 150 57 / var(--tw-text-opacity, 1));
}
.text-uae-red {
  --tw-text-opacity: 1;
  color: rgb(206 17 38 / var(--tw-text-opacity, 1));
}
.text-white {
  --tw-text-opacity: 1;
...
.gradient-uae {
    background: linear-gradient(135deg, #CE1126 0%, #009639 100%);
  }

/* UAE-specific gradients and patterns */
...
.hover\:border-uae-green\/20:hover {
  border-color: rgb(0 150 57 / 0.2);
}
...
.hover\:bg-uae-green:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(0 150 57 / var(--tw-bg-opacity, 1));
}

.hover\:bg-uae-green\/90:hover {
  background-color: rgb(0 150 57 / 0.9);
}
...
.focus\:ring-uae-green:focus {
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(0 150 57 / var(--tw-ring-opacity, 1));
}
